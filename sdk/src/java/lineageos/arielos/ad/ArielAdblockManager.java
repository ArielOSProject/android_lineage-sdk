 ...
 * @hide
 */
public final class ArielAdblockManager {
    ...
    private static ArielAdblockManager sInstance;
    private static ILineageAudioService sService;

    /**
     * @hide to prevent subclassing from outside of the framework
     */
    private ArielAdblockManager(Context context) {
    ...
    /**
     * Get or create an instance of the {@link ArielAdblockManager}
     * @param context
     * @return {@link ArielAdblockManager}
     */
    public synchronized static ArielAdblockManager getInstance(Context context) {
        if (sInstance == null) {
            sInstance = new ArielAdblockManager(context);
        }
        return sInstance;
    }
